		...
		<div class="activity-comments">
			...
			<?php if ( is_user_logged_in() ) : ?>
				<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form"<?php bp_activity_comment_form_nojs_display(); ?>>
					<div class="activity-reply-avatar"><?php bp_loggedin_user_avatar( 'width=' . BP_AVATAR_THUMB_WIDTH . '&height=' . BP_AVATAR_THUMB_HEIGHT ); ?></div>
					<div class="activity-reply-content">
						<div class="activity-textarea">
							<textarea id="activity-textarea-<?php bp_activity_id(); ?>" class="activity-textarea" name="activity_textarea_<?php bp_activity_id(); ?>"></textarea>
						</div>
						<input type="submit" name="activity_submit" value="<?php _e( 'Post', 'buddypress' ); ?>" /> &nbsp; <?php _e( 'or press esc to cancel.', 'buddypress' ); ?>
