...
<form action="" id="bp_group_search" method="get">
	...
	<input class="search" id="bp_group_search_box" type="search" name="s" placeholder="<?php echo esc_attr( bp_get_search_default_text( 'groups' ) ); ?>" value="<?php echo esc_attr( ! empty( $_REQUEST['s'] ) ? stripslashes( $_REQUEST['s'] ) : '' ); ?>" required autofocus />
