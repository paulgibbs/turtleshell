<?php
/**
 * Members Capabilities content part
 *
 * @package BuddyPress
...
<h4><?php _e( 'Capabilities', 'buddypress' ); ?></h4>
...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/capabilities/'; ?>" name="account-capabilities-form" id="account-capabilities-form" class="standard-form" method="post">
	...
	<?php do_action( 'bp_template_members_capabilities_account_before_submit' ); ?>
	...
	<?php do_action( 'bp_template_members_capabilities_account_after_submit' ); ?>
