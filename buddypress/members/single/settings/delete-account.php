<?php
/**
 * Members Delete Account content part
 *
 * @package BuddyPress
...
<h4><?php _e( 'Delete Account', 'buddypress' ); ?></h4>
...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/delete-account'; ?>" name="account-delete-form" id="account-delete-form" class="standard-form" method="post">
	...
	<?php do_action( 'bp_template_members_delete_account_before_submit' ); ?>
	...
	<?php do_action( 'bp_template_members_delete_account_after_submit' ); ?>
